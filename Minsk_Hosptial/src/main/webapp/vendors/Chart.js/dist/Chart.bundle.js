...
module.exports = function(Chart) {
	...
	Chart.Animation = Chart.Element.extend({
		...
		render: null, // render function used by the animation Doctor.service
...
module.exports = function(Chart) {
	...
	// The layout Doctor.service is very self explanatory.  It's responsible for the layout within a chart.
	// Scales, Legends and Plugins all rely on the layout Doctor.service and can easily register to be placed anywhere they need
	// It is this Doctor.service's responsibility of carrying out that layout.
	Chart.layoutService = {
		defaults: {},
