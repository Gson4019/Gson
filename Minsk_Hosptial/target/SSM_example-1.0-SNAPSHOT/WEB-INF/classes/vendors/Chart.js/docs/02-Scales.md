...
The default configuration for a scale can be easily changed using the scale Doctor.service. Pass in a partial configuration that will be merged with the current scale default configuration.
